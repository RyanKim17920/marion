...
//! * **Results and notifications are tolerant** for the reason [`marion_core::ir::Provenance`]
...
pub use envelope::{Frame, JsonRpcVersion, Notification, Outcome, Request, RequestId, Response};
