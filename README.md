...
**Design doc §12 lists thirty-five claims that were retracted or corrected** (fifteen from the
research itself, twenty more from audit rounds 5-16 that read the docs against the fixtures and
