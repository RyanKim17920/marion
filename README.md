...
**Design doc §12 lists twenty-seven claims that were retracted or corrected** (fifteen from the
research itself, twelve more from audit rounds 5-14 that read the docs against the fixtures and
