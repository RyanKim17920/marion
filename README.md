...
**Design doc §12 lists thirty-two claims that were retracted or corrected** (fifteen from the
research itself, seventeen more from audit rounds 5-15 that read the docs against the fixtures and
