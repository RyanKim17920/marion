...
Turn 2 deliberately BLOCKS for S15_HOLD_SECS before answering. That keeps
...
REQLOG = os.getenv("S15_REQLOG", "/tmp/s15-requests.jsonl")
PORT = int(os.getenv("S15_PORT", "8099"))
SPAWN_SH = os.environ["S15_SPAWN_SH"]        # case A script (orphan)
PIDFILE = os.environ["S15_PIDFILE"]          # case A pidfile
RUNAWAY_SH = os.environ["S15_RUNAWAY_SH"]    # case B script (still running)
RUNAWAY_PIDFILE = os.environ["S15_RUNAWAY_PIDFILE"]
HOLD_SECS = int(os.getenv("S15_HOLD_SECS", "120"))
